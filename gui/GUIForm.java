...
public class GUIForm extends JFrame {
    ...
    private JLayeredPane statusBar; // Cambiado a JLayeredPane para permitir la superposición
    ...
    private void createSections() {
        ...
        statusBar = new JLayeredPane();
        statusBar.setPreferredSize(new Dimension(WINDOW_SIZE.width, 150)); // Dimensión ajustada
        addBackgroundImage(statusBar, "gui/images/Background 1.jpg", WINDOW_SIZE.width, 150);

        // Agregar la barra de vida en la esquina superior derecha
        ImageIcon lifeBarIcon = new ImageIcon("gui/images/Life_bar.png");
        Image scaledLifeBarImage = lifeBarIcon.getImage().getScaledInstance(150, 100, Image.SCALE_SMOOTH); // Tamaño de la barra de vida
        JLabel lifeBarLabel = new JLabel(new ImageIcon(scaledLifeBarImage));
        lifeBarLabel.setBounds(WINDOW_SIZE.width - 190, 10, 150, 100); // Ajustar posición y tamaño
        statusBar.add(lifeBarLabel, Integer.valueOf(1)); // Agregar en capa superior
        ...
        addBackgroundImage(gamePanel, "gui/images/Background 2.jpg", WINDOW_SIZE.width, 370);

        // Imagen del jugador (en capa superior)
        ImageIcon playerIcon = new ImageIcon("gui/images/Player.png");
        Image scaledPlayerImage = playerIcon.getImage().getScaledInstance(150, 150, Image.SCALE_SMOOTH);
        JLabel playerLabel = new JLabel(new ImageIcon(scaledPlayerImage));
        playerLabel.setBounds(100, 175, 150, 150); // Posición y tamaño del jugador en el panel
        ...
        addBackgroundImage(actionBar, "gui/images/Background 3.jpg", WINDOW_SIZE.width, 340);
    ...
    private void createButtons() {
        ...
        addButtonIcon(saveButton, "gui/images/save_icon.jpg", 40, 40);
        addButtonIcon(exitButton, "gui/images/exit_icon.jpg", 40, 40);
        addButtonIcon(inventoryButton, "gui/images/inventory_icon.jpg", 40, 40);
        addButtonIcon(statsButton, "gui/images/stats_icon.jpg", 40, 40);
